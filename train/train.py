...
class MaskDecoderHQ(MaskDecoder):
    def __init__(self, model_type):
        ...
        checkpoint_dict = {"vit_b":"/kaggle/working/hqsam_eval_coco/train/pretrained_checkpoint/sam_vit_b_maskdecoder.pth",
...
def main(net, train_datasets, valid_datasets):
    ...
    sam = sam_model_registry["vit_b"](checkpoint="/kaggle/working/hqsam_eval_coco/train/pretrained_checkpoint/sam_vit_b_01ec64.pth").to(device="cuda")
